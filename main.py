...
pygame.font.Font("NightPumpkind-1GpGv.ttf", 20)
small_font = pygame.font.Font("Blacknorthdemo-mLE25.ttf", 20)
big_font = pygame.font.Font("Blacknorthdemo-mLE25.ttf", 60)
